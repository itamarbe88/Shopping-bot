...
export default function PurchaseScreen() {
  ...
  const sections = React.useMemo(() => {
    ...
    const CATEGORY_ORDER = [
      "ירקות ופירות", "חלב וגבינות", "מוצרי חלב", "בשר ודגים", "מאפים",
      "שימורים", "קטניות", "מוצרי מזווה", "תבלינים", "רטבים",
      "משקאות", "חטיפים", "חטיפים ומתוקים", "מתוקים", "ממרחים", "פיצוחים",
      "מוצרי ניקוי", "מוצרי טיפוח", "מוצרי נייר", "מוצרי אריזה", "שונות",
    ];
